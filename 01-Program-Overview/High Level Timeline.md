...
## Phase 1: Registration (Pre-Program)
...
## Phase 2: Kickoff Meeting (Week 1)

> The Kickoff Meeting is combined with the first weekly readiness meeting.

5. **Program overview** — Establish expectations, explain how the program works, and clarify pre-event requirements.
6. **Introductions** — Participants meet each other and the collaboration model is introduced.
7. **Agenda and milestones** — Review event agenda, milestones, and participation requirements.
8. **Homework assigned** — Business and technical readiness artifacts are assigned.
9. **Pre-skilling assigned** — Participants directed to the Microsoft AI Co-Innovation Lab Getting Started curriculum.

---

## Phase 3: Homework & Pre-Skilling (Weeks 1–4)

### Business Readiness Homework
10. Write a one-paragraph use case statement.
11. Define the desired business outcome.
12. Establish success criteria.
13. Identify sample user questions.
14. Gather sample documents and data.

### Technical Readiness Homework
15. Verify Azure subscription access.
...
## Phase 4: Weekly Readiness Meetings (Weeks 1–4)

> Objective: Eliminate business and technical barriers before event week.
...
## Phase 6: The Event — Day 1 (9:00 AM – 3:00 PM)
